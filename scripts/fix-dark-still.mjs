...
async function generateDarkStill() {
  ...
  // Toggle theme to dark first while header is still visible
  ...
  console.log('Waiting for 3D model to assemble in dark theme...');
  await page.waitForTimeout(10000);

  // Hide DOM text overlays
  await page.evaluate(() => {
...
generateDarkStill().catch(console.error);
